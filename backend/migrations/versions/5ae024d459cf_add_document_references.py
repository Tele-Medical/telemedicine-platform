...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_document_references_appointment_id"),
        "document_references",
        ["appointment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_document_references_patient_id"),
        "document_references",
        ["patient_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_document_references_uploaded_by_user_id"),
        "document_references",
        ["uploaded_by_user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_document_references_uploaded_by_user_id"), table_name="document_references"
    )
