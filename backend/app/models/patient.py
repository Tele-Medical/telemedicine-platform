...
class Patient(Base):
    ...
    phone: Mapped[str | None] = mapped_column(String, nullable=True) # Guardian phone if child/elderly
    ...
    identifiers: Mapped[list["PatientIdentifier"]] = relationship("PatientIdentifier", back_populates="patient")
