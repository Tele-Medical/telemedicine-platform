...
class Encounter(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "encounter_mode IN ('video', 'audio', 'async', 'audio_fallback')",
            name="encounters_mode_check",
        ),
        CheckConstraint(
            "status IN ('in_progress', 'completed', 'cancelled')", name="encounters_status_check"
        ),
    )
