...
def evaluate_symptoms_and_route(db: Session, intake: SymptomIntakeBase) -> Dict[str, Any]:
    ...
    ortho_keywords = [
        ...
        "strain", "sprain", "spine", "shoulder", "neck", "arthritis",
        "swelling", "dislocation", "ligament", "tendon", "cramp", "backache",
        "slipped disc", "sciatica", "lumbar", "heavy lifting", "moving furniture", 
        "orthopedic concern", "muscle strain", "joint discomfort"
    ]
