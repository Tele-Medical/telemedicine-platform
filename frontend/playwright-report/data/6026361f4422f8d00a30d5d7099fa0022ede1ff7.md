...
- Name: workflow.spec.ts >> Nabha Telemedicine Platform - Phase 4 E2E Workflows >> 1. ASHA Worker Onboarding, Offline Mode, & Reconnect Sync Journey
- Location: e2e/workflow.spec.ts:5:3
...
Locator: getByText(/Offline Mode/i)
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText(/Offline Mode/i)
...
- main:
  - heading "Assisted Checkups" [level=1]
  - paragraph: Collect clinical patient vitals, register new rural digital health profiles, and coordinate teleconsultations.
  - button "New Patient Registration Register new offline profiles with E.164 phone linkage.":
    - heading "New Patient Registration" [level=3]
    - paragraph: Register new offline profiles with E.164 phone linkage.
  - button "Collect Vitals & Triage Measure blood pressure, temperature, and triage patient discomfort.":
    - heading "Collect Vitals & Triage" [level=3]
    - paragraph: Measure blood pressure, temperature, and triage patient discomfort.
  - heading "Today's Active Checks" [level=2]
  - text: No assisted patient records registered yet today.
