  ...
  return (
    <div className="animate-fade-in pb-12">
      <header className="mb-6 mt-2">
        <h1 className="text-2xl font-bold text-neutral-900 tracking-tight">Medicine Dispensary Inventory</h1>
        <p className="text-neutral-500 text-sm mt-1">Track medicine stock balances, low stock alerts, and trigger supply replenishment orders.</p>
      </header>
          ...
          <div key={item.id} className="bg-white rounded-2xl border border-neutral-200/60 p-5 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 border-t sm:border-t-0 border-neutral-100 pt-3.5 sm:pt-0 shrink-0">
              <div className="text-right">
                <span className="text-[10px] text-neutral-400 font-black tracking-wider uppercase block">STOCK</span>
                <span className="text-sm font-bold text-neutral-800">{item.stock} Units</span>
              </div>
              <div className="text-right">
                <span className="text-[10px] text-neutral-400 font-black tracking-wider uppercase block">MIN REQUIRED</span>
