...
const EncounterClosureForm: React.FC<{ encounterId: string }> = ({ encounterId }) => {
  ...
  if (status === 'success') {
    return (
      <div className="bg-green-50 p-8 rounded-xl border border-green-200 text-center shadow-sm">
        ...
        <h3 className="text-xl font-bold text-green-900 mb-2">Encounter Finalized</h3>
        <p className="text-green-700 font-medium">The clinical summary has been securely saved to the patient record.</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      <h3 className="text-xl font-bold mb-6 text-gray-800 border-b pb-3">Encounter Closure</h3>
